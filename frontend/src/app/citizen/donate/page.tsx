...
import { ChevronRight, ArrowLeft, HeartHandshake } from 'lucide-react';
...
export default function CitizenDonateRoute() {
  return (
    <LedgerProvider>
        ...
        <div className="bg-white border-b border-gray-300 py-2 px-3 sm:px-6">
          <div className="max-w-7xl mx-auto flex items-center justify-between text-xs text-gray-600">
            <div className="flex items-center gap-2">
              <Link href="/citizen" className="hover:text-[#0B3D6E] flex items-center gap-1 font-medium">
